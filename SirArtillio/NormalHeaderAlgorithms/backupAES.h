...
public:
    int input() {
        ...
        cout << "Enter 16 hexadecimal values (2-digit, 00 to FF) for the plaintext (4x4 matrix):" << endl;
        for (int i = 0; i < Nb; ++i) {
            for (int j = 0; j < Nb; ++j) {
                string input;
        ...
        char choice;
        cout << "Do you want to input your own round key? (y/n): ";
        cin >> choice;
        if (choice == 'y' || choice == 'Y') {
            ...
            cout << "Generated random round key: " << endl;
            for (int i = 0; i < Nb * 4; ++i) {
        ...
        cout << "\n\n";
        sub_bytes(state);
        display_state(state, "After SubBytes:");
        cout << "\n\n";
        shift_rows(state);
        display_state(state, "After ShiftRows:");
        cout << "\n\n";
        mix_columns(state);
        display_state(state, "After MixColumns:");

        cout << "\n\n";
        display_state(state, "Final State after 1 round of AES:");
        cout << "\n\n| ===== AES ===== |\n\n";
        return again();
    }
};
